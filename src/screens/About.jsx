      ...
      <div id='abouttext'>
        <strong>
          ...
          <p>
            ...
            knows what it takes for children to have fun.
          </p>
          <br />
          <p>
            We cater to both boys and
          ...
          <br />
          <p>
            <a href={GamingContract} download="Contract" style={{textDecoration: 'underline', color: 'rgb(255, 172, 43)'}}>
